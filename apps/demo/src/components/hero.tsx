  ...
  return (
    <section id="hero" className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        ...
        <h1 className="special-font hero-heading absolute right-5 bottom-5 z-40 bg-white bg-clip-text text-transparent">
          G<b>a</b>ming
        </h1>

        <div className="absolute top-0 left-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            <h1 className="special-font hero-heading bg-white bg-clip-text text-transparent">
              Redefi<b>n</b>ed
            </h1>
      ...
      <h1 className="special-font hero-heading absolute right-5 bottom-5 bg-white bg-clip-text text-transparent">
        G<b>a</b>ming
      </h1>
    </section>
  );
